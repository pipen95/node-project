...
module.exports = {
  ...
  "_spec": "axios@^0.21.1",
  "_where": "C:\\Users\\Pierre\\Desktop\\Projects\\projects\\complete-node-bootcamp\\4-natours\\starter",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              window.setTimeout(function () {
                location.assign('/');
                (0, _alert.showAlert)('success', "Login successfull!");
              }, 500);
            }
...
if (userDataForm) userDataForm.addEventListener("submit", function (e) {
  ...
  console.log(form);
  (0, _updateSettings.updateSettings)(form, "information");
});
